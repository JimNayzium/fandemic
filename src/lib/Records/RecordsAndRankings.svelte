            ...
            <Body>
                {#each weekRecords as leagueWeekRecord, ix}
                    <Row>
                        ...
                        <Cell class="cellName" on:click={() => gotoManager({year: leagueWeekRecord.year || prefix, leagueTeamManagers, rosterID: leagueWeekRecord.rosterID})}  on:keypress={() => gotoManager({year: leagueWeekRecord.year || prefix, leagueTeamManagers, rosterID: leagueWeekRecord.rosterID})}>
        ...
        <DataTable class="recordTable">
            ...
            <Body>
                {#each weekLows as leagueWeekLow, ix}
                    <Row>
                        <Cell class="rank">{ix + 1}</Cell>
                        <Cell class="cellName" on:click={() => gotoManager({year: leagueWeekLow.year || prefix, leagueTeamManagers, rosterID: leagueWeekLow.rosterID})}  on:keypress={() => gotoManager({year: leagueWeekLow.year || prefix, leagueTeamManagers, rosterID: leagueWeekLow.rosterID})}>
        ...
        <DataTable class="recordTable">
            ...
            <Body>
                {#each seasonLongRecords as mostSeasonLongPoint, ix}
                    <Row>
                        <Cell class="rank">{ix + 1}</Cell>
                        <Cell class="cellName" on:click={() => gotoManager({year: mostSeasonLongPoint.year, leagueTeamManagers, rosterID: mostSeasonLongPoint.rosterID})}  on:keypress={() => gotoManager({year: mostSeasonLongPoint.year, leagueTeamManagers, rosterID: mostSeasonLongPoint.rosterID})}>
        ...
        <DataTable class="recordTable">
            ...
            <Body>
                {#each seasonLongLows as leastSeasonLongPoint, ix}
                    <Row>
                        <Cell class="rank">{ix + 1}</Cell>
                        <Cell class="cellName" on:click={() => gotoManager({year: leastSeasonLongPoint.year, leagueTeamManagers, rosterID: leastSeasonLongPoint.rosterID})}  on:keypress={() => gotoManager({year: leastSeasonLongPoint.year, leagueTeamManagers, rosterID: leastSeasonLongPoint.rosterID})}>
                ...
                {#each blowouts as blowout, ix}
                    <Row>
                        ...
                        <Cell class="cellName differentialName">
                            <div class="vsRecord">
                                <div on:click={() => gotoManager({year: blowout.home.year || prefix, leagueTeamManagers, rosterID: blowout.home.rosterID})}  on:keypress={() => gotoManager({year: blowout.home.year || prefix, leagueTeamManagers, rosterID: blowout.home.rosterID})}>
                                ...
                                <div on:click={() => gotoManager({year: blowout.away.year || prefix, leagueTeamManagers, rosterID: blowout.away.rosterID})}  on:keypress={() => gotoManager({year: blowout.away.year || prefix, leagueTeamManagers, rosterID: blowout.away.rosterID})}>
            ...
            <Body>
                {#each closestMatchups as closestMatchup, ix}
                    <Row>
                        ...
                        <Cell class="cellName differentialName">
                            <div class="vsRecord">
                                <div on:click={() => gotoManager({year: closestMatchup.home.year || prefix, leagueTeamManagers, rosterID: closestMatchup.home.rosterID})}  on:keypress={() => gotoManager({year: closestMatchup.home.year || prefix, leagueTeamManagers, rosterID: closestMatchup.home.rosterID})}>
                                ...
                                <div on:click={() => gotoManager({year: closestMatchup.away.year || prefix, leagueTeamManagers, rosterID: closestMatchup.away.rosterID})}  on:keypress={() => gotoManager({year: closestMatchup.away.year || prefix, leagueTeamManagers, rosterID: closestMatchup.away.rosterID})}>
                ...
                <DataTable class="rankingTable">
                    ...
                    <Body>
                        {#each lineupIQs as lineupIQ, ix}
                            <Row>
                                <Cell>{ix + 1}</Cell>
                                <Cell class="cellName" on:click={() => gotoManager({year: lineupIQ.year || prefix, leagueTeamManagers, managerID: lineupIQ.managerID, rosterID: lineupIQ.rosterID})}  on:keypress={() => gotoManager({year: lineupIQ.year || prefix, leagueTeamManagers, managerID: lineupIQ.managerID, rosterID: lineupIQ.rosterID})}>
            ...
            <DataTable class="rankingTable">
                ...
                <Body>
                    {#each winPercentages as winPercentage, ix}
                        <Row>
                            <Cell>{ix + 1}</Cell>
                            <Cell class="cellName" on:click={() => gotoManager({year: winPercentage.year || prefix, leagueTeamManagers, rosterID: winPercentage.rosterID, managerID: winPercentage.managerID})}  on:keypress={() => gotoManager({year: winPercentage.year || prefix, leagueTeamManagers, rosterID: winPercentage.rosterID, managerID: winPercentage.managerID})}>
            ...
            <DataTable class="rankingTable">
                ...
                <Body>
                    {#each fptsHistories as fptsHistory, ix}
                        <Row>
                            <Cell>{ix + 1}</Cell>
                            <Cell class="cellName" on:click={() => gotoManager({year: fptsHistory.year || prefix, leagueTeamManagers, rosterID: fptsHistory.rosterID, managerID: fptsHistory.managerID})}  on:keypress={() => gotoManager({year: fptsHistory.year || prefix, leagueTeamManagers, rosterID: fptsHistory.rosterID, managerID: fptsHistory.managerID})}>
            ...
            <DataTable class="rankingTable">
                ...
                <Body>
                    {#each transactions as transaction, ix}
                        <Row>
                            <Cell>{ix + 1}</Cell>
                            <Cell class="cellName" on:click={() => gotoManager({year: transaction.year || prefix, leagueTeamManagers, rosterID: transaction.rosterID, managerID: transaction.managerID})}  on:keypress={() => gotoManager({year: transaction.year || prefix, leagueTeamManagers, rosterID: transaction.rosterID, managerID: transaction.managerID})}>
...
<div class="buttonHolder">
    <Group variant="outlined">
        {#each tables as table, ix}
            <Button class="selectionButtons" on:click={() => curTable = ix} v  on:click={() => curTable = ix} variant="{curTable == ix ? "raised" : "outlined"}">
                <Label>{table}</Label>
            </Button>
        {/each}
    </Group>
